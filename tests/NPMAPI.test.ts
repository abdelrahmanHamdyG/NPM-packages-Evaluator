...
describe("NpmAPI Tests", () => {
    ...
    test("prints the correct data", () => {
        ...
        expect(logSpy).toHaveBeenNthCalledWith(1, 1, "NPM Data:");
        expect(logSpy).toHaveBeenNthCalledWith(2, 1, "License: MIT");
        expect(logSpy).toHaveBeenNthCalledWith(3, 1, "GitHub URL: https://github.com/test/repo");
        expect(logSpy).toHaveBeenNthCalledWith(4, 2, "NPM Data:");
        expect(logSpy).toHaveBeenNthCalledWith(5, 2, "License: MIT");
        expect(logSpy).toHaveBeenNthCalledWith(6, 2, "GitHub URL: https://github.com/test/repo");
        //restoring the spy
        logSpy.mockRestore();
      });
      test("prints the incorrect data", () => {
        ...
        //check if Logger.log was called with the correct arguments
        expect(logSpy).toHaveBeenNthCalledWith(1, 1, "NPM Data:");
        expect(logSpy).toHaveBeenNthCalledWith(2, 1, "License: empty");
        expect(logSpy).toHaveBeenNthCalledWith(3, 1, "GitHub URL: empty");
        expect(logSpy).toHaveBeenNthCalledWith(4, 2, "NPM Data:");
        expect(logSpy).toHaveBeenNthCalledWith(5, 2, "License: empty");
        expect(logSpy).toHaveBeenNthCalledWith(6, 2, "GitHub URL: empty");
        //restoring the spy
        logSpy.mockRestore();
      });
